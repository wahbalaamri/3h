...
<div class="container pt-5 mt-5">
    <div class="row">
        ...
        <div class="col-9">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading{{ $loop->iteration }}">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    {{App()->getLocale()=='ar'?
                                    $partnerShipPlan->PlanTitleAr:$partnerShipPlan->PlanTitle }}
                                </button>
                            </h2>
                            <div id="collapse{{ $loop->iteration }}"
                                ...
                                <div class="accordion-body">
                                    <div class="list-group w-50">
                                        ...
                                        <div class="list-group-item" style="background-color: #fff; color:#eead35"><span
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Remote Plans (ON') }} <a href="https://www.hrfactoryapp.com"
                            class="badge text-bg-secondary">{{ __('HRFactoryApp') }}</a> {{ __('Database)') }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
